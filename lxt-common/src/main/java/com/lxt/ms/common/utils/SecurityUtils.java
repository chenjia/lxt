...
public class SecurityUtils {
	...
	public static String encryptKey(String key) throws Exception {
        ...
        return new Base64Encoder().encode(new StringBuilder(encryptedKey).reverse().toString().getBytes(encoding)).replaceAll("\n", "");
    }
	...
	public static void main(String[] args) throws Exception {
        ...
        String base64 = encryptKey(key);
        System.out.println(base64);
        System.out.println(decryptKey(base64));
	}
}
