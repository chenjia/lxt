...
$(_1dd).html('<table class="loading" style="background:white;position:relative;top:0px;left:0px;margin:0px;padding:0px;width:100%;height:100%;"><tr><td align="center"><img src="../../images/loading.gif"><br/><br/><span>页面加载中...</span></td></tr></table>');
}
...
function _1e0(_1e1){
$(_1dd).html(_1e1);
var loading = $(_1dd).find('.loading');
$.parser.onComplete = function(){
	setTimeout(function(){loading.fadeOut();},1000);
};
$(_1dd).css({overflow:'hidden'});
loading.css({top:'-100%'}).before(_1e1);
if($.parser){
$.parser.parse($(_1dd));
}
};
